...
def createDungeon():
    doors = [
        {'attribute': 'Wooden', 'weight': 11, 'subtraits': []},
        {'attribute': 'Wooden, barred', 'weight': 1, 'subtraits': []},
        {'attribute': 'Wooden, locked', 'weight': 1, 'subtraits': []},
        {'attribute': 'Stone', 'weight': 1, 'subtraits': []},
        {'attribute': 'Stone, barred', 'weight': 0.5, 'subtraits': []},
        {'attribute': 'Stone, locked', 'weight': 0.5, 'subtraits': []},
        {'attribute': 'Iron', 'weight': 1, 'subtraits': []},
        {'attribute': 'Iron, barred', 'weight': 0.5, 'subtraits': []},
        {'attribute': 'Iron, locked', 'weight': 0.5, 'subtraits': []},
        {'attribute': 'Portcullis', 'weight': 1, 'subtraits': []},
        {'attribute': 'Portcullis, locked in place', 'weight': 1, 'subtraits': []},
        {'attribute': 'Secret door', 'weight': 1, 'subtraits': []},
        {'attribute': 'Secret door, barred or locked', 'weight': 1, 'subtraits': []},
    ]
    chamber_exits = [
    ...
    large_chamber_exits = [
        {'attribute': 'None', 'weight': 3, 'subtraits': []},
        {'attribute': 'One exit', 'weight': 5, 'subtraits': [chamber_exits]},
        {'attribute': 'Two exits', 'weight': 5, 'subtraits': [chamber_exits, chamber_exits]},
    ...
    chambers = [
        ...
        {'attribute': 'Octagon, 40x40 ft', 'weight': 1, 'subtraits': [chamber_contents, large_chamber_exits]},
        {'attribute': 'Octagon, 60x60 ft', 'weight': 1, 'subtraits': [chamber_contents, large_chamber_exits]},
        {'attribute': 'Trapezoid, 40x60 ft', 'weight': 1, 'subtraits': [chamber_contents, large_chamber_exits]},
    ]
    passage_widths = [
        {'attribute': '5 ft wide', 'weight': 2, 'subtraits': []},
        {'attribute': '10 ft wide', 'weight': 10, 'subtraits': []},
        {'attribute': '20 ft wide', 'weight': 2, 'subtraits': []},
        {'attribute': '30 ft wide', 'weight': 2, 'subtraits': []},
    ...
    branched_passages = [
        ...
        {'attribute': 'Continue straight 20 ft, side passage to the right, then an additional 10 ft ahead', 'weight': 2, 'subtraits': [passage_widths[0:2]]},
        {'attribute': 'Continue straight 20 ft, side passage to the left, then an additional 10 ft ahead', 'weight': 2, 'subtraits': [passage_widths[0:2]]},
        {'attribute': 'Continue straight 20 ft, comes to a dead end', 'weight': 0.5, 'subtraits': [passage_widths[0:2]]},
        {'attribute': 'Continue straight 20 ft, comes to a dead end with a secret door', 'weight': 0.5, 'subtraits': [passage_widths[0:2]]},
        {'attribute': 'Continue straight 20 ft, then the passage turns left and continues 10 ft', 'weight': 2, 'subtraits': [passage_widths[0:2]]},
        {'attribute': 'Continue straight 20 ft, then the passage turns right and continues 10 ft', 'weight': 2, 'subtraits': [passage_widths[0:2]]},
    ...
    return pickTrait(starting_areas)
